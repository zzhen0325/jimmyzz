...
function Hero() {
  ...
  return (
    <section id="top" ref={hero} className="relative h-svh min-h-[720px] overflow-hidden bg-[#06141b] min-[810px]:after:pointer-events-none min-[810px]:after:absolute min-[810px]:after:z-1 min-[810px]:after:content-[''] min-[810px]:after:inset-[45px_var(--page-pad)_98px] min-[810px]:after:bg-[repeating-linear-gradient(90deg,rgba(255,255,255,.085)_0_1px,transparent_1px_calc(25%_-_1px))] max-[809px]:min-h-[844px]">
      <motion.div className="absolute -inset-[4%] max-[809px]:inset-0" style={{y,scale}}><Image className="object-cover object-[center_44%] max-[809px]:object-[55%_center]" src="/assets/images/bg7.png" fill priority sizes="100vw" alt="Cinematic scene lit in blue and amber" /></motion.div>
      ...
      <motion.h1 className="absolute right-[1.3%] bottom-9 left-[1.3%] z-3 m-0 w-[163%] origin-bottom-left scale-x-[.975] whitespace-nowrap text-[21vw] leading-[.78] font-[480] tracking-[-.075em] max-[809px]:right-auto max-[809px]:bottom-6 max-[809px]:left-[1.3%] max-[809px]:w-[109%] max-[809px]:scale-x-[.92] max-[809px]:text-[21vw]" initial={{opacity:0,y:48}} animate={{opacity:1,y:0}} transition={{duration:.85,ease:[.2,.7,.2,1]}}>VibeMaking</motion.h1>
    </section>
  );
}
